            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body" style="padding:30px;">
                        <div class="dd">
                            {!! menu($menu->name, 'admin.menu_data', ['isModelTranslatable' => $isModelTranslatable]) !!}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <br><input type="checkbox" value="1" id="m_members_only" name="members_only">
                        <label for="m_members_only">For members only?</label>
    ...
    <script>
        $(document).ready(function () {
            ...
            $m_modal.on('show.bs.modal', function(e, data) {
                var _adding      = !e.relatedTarget.data,
                ...
                if (_adding) {
                    ...
                    $m_members_only.prop('checked', _src.data('members_only'));
